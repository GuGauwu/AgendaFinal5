            ...
            <table class="table table-sm">
                    ...
                    <tbody>
                        <?php
                            ...
                            $registros = consulta("materia");
                            foreach($registros as $registro) {
                                echo "<tr>";
                                echo "<td>".$registro['idmateria']."</td>";
                                echo "<td>".$registro['nom_materia']."</td>";
                                
                                echo "<td><a class='btn btn-danger' href='eliminar_m.php?id=".$registro['idmateria']."' onclick='confirmarEliminacion(event);'>Eliminar</a></td>";
                                echo "<td><a class='btn btn-warning' href='modificar_m.php?id=".$registro['idmateria']."' onclick='confirmacionModificar(event)'>Modificar</a></td>";
                                echo "</tr>";
                            }
                        ?>
                    </tbody>
                ...
                <div class="mb-4 mx-auto" class="form-label">
                    <a href="agregar_m.php" class="btn btn-secondary">Agregar</a>
                </div>
        </div>
    </article>
